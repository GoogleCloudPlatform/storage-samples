...
8. [poc-readiness-assessment](./poc-readiness-assessment) - This tool automates the evaluation of customer configurations for SAP HANA and Db2 environments to ensure GCBDR POC readiness using Persistent Disk (PD) snapshots.
